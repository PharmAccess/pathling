 ...
 * Instance of any class annotated with @SpringBootUnitTest (and other relevant annotations related
 * to spring context configuration) can be autowired  by the {@link #autowireWithTestContext(Object)}
 */
public class SpringBootJmhContext {
  ...
  /**
   * Autowires an instance of a class annotated with @SpringBootUnitTest using the test context
