...
public class Spark {
  ...
  /**
   * @param configuration a {@link SparkConfiguration} object containing the parameters to use in
   * the creation
  ...
  // TODO: is this needed everyhere: @ConditionalOnMissingBean
  @Nonnull
  public static SparkSession build(@Nonnull final SparkConfiguration configuration,
