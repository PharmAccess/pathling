...
@Slf4j
public class AsyncJobProgressUpdateSparkListener extends SparkListener {
   ...
   */
  public AsyncJobProgressUpdateSparkListener(@Nonnull final JobRegistry jobRegistry,
